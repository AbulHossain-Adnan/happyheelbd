          ...
          <div class="form-layout">
            <div class="row mg-b-25">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  <input class="form-control" type="integer" name="selling_price" placeholder="Enter product selling price" value="{{old('selling_price')}}">
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  <input class="form-control" type="integer" name="discount_price" placeholder="Enter product discount price" value="{{old('discount_price')}}">
                </div>
              </div><!-- col-4 -->
            ...
            <!--   <div class="col-lg-12">
                ...
                <div class="form-group">
                  ...
                  <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  <textarea class="form-control" type="text" name="product_details" ></textarea>
