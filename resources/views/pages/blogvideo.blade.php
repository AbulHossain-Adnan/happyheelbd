        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb justify-content-md-end">
                    ...
                    <li class="breadcrumb-item active">Blog Single Post Video</li>
                </ol>
            </div>
        </div>
    </div><!-- END CONTAINER-->
            	...
            	<div class="single_post">
                    ...
                    <div class="blog_img">
                        <div class="fit-videos">
                            <iframe width="825" height="550" src="https://www.youtube.com/embed/7e90gBu4pas" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                        </div>
                    </div>
                            ...
                            <div class="row">
                            	<div class="col-sm-6">
                                	<div class="single_img">
                                		<img class="w-100 mb-4" src="{{ asset('templateassets') }}/assets/images/blog_single_img1.jpg" alt="blog_single_img1">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                	<div class="single_img">
                                		<img class="w-100 mb-4" src="{{ asset('templateassets') }}/assets/images/blog_single_img2.jpg" alt="blog_single_img2">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="comment-area">
                    ...
                    <ul class="list_none comment_list">
                        <li class="comment_info">
                            ...
                            <ul class="children">
                            	<li class="comment_info">
                                    <div class="d-flex">
                                        <div class="comment_user">
                                            <img src="{{ asset('templateassets') }}/assets/images/user3.jpg" alt="user3">
                                        </div>
                                        <div class="comment_content">
                        ...
                        <li class="comment_info">
                            <div class="d-flex">
                                <div class="comment_user">
                                    <img src="{{ asset('templateassets') }}/assets/images/user4.jpg" alt="user4">
                                </div>
                                <div class="comment_content">
                                    <div class="d-flex">
                                        <div class="meta_data">
                        ...
                        <ul class="widget_recent_post">
                            <li>
                                <div class="post_footer">
                                    <div class="post_img">
                                        <a href="#"><img src="{{ asset('templateassets') }}/assets/images/letest_post1.jpg" alt="letest_post1"></a>
                                    </div>
                            ...
                            <li>
                                <div class="post_footer">
                                    <div class="post_img">
                                        <a href="#"><img src="{{ asset('templateassets') }}/assets/images/letest_post2.jpg" alt="letest_post2"></a>
                                    </div>
                                    <div class="post_content">
                                        <h6><a href="#">Lorem ipsum dolor sit amet, consectetur</a></h6>
                                        <p class="small m-0">April 14, 2018</p>
                            ...
                            <li>
                                <div class="post_footer">
                                    <div class="post_img">
                                        <a href="#"><img src="{{ asset('templateassets') }}/assets/images/letest_post3.jpg" alt="letest_post3"></a>
                                    </div>
                                    <div class="post_content">
                                        <h6><a href="#">Lorem ipsum dolor sit amet, consectetur</a></h6>
                                        <p class="small m-0">April 14, 2018</p>
