        ...
        <div class="row align-items-center">
        	<div class="col-md-6">
                <div class="page-title">
            		<h1>Product Detail's <i class="fa-solid fa-circle-info"></i> <i class="fa-solid fa-circle-info"></i></h1>
                </div>
            </div>
            <div class="col-md-6">
		...
		<div class="row">
            <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
              <div class="product-image">
                    <div class="product_img_box">
                        ...
                        <img id="product_img" src='{{ asset('product_images/'.@$product->files[0]['product_image']) }}' data-zoom-image="{{ asset('product_images/'.@$product->files[0]['product_image']) }}" alt="product_img1" />
                ...
                <div class="pr_detail">
                    <div class="product_description">
                        ...
                        <div class="product_sort_info">
                            <ul>
                                <li><i class="linearicons-shield-check"></i> Offer is valid only for happyhealbd.com</li>
            ...
            <div class="">
              ...
              <div class="form-check form-check-inline">
                <input style="border: 1px solid red;" class="form-check-input" type="radio" name="size" id="size" value="{{ $size }}" {{$key == 0? "checked" :"" }}>
          ...
          <div class="">
            ...
            <div class="product_color_switch">
              ...
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="color" id="color" value="{{$color}}" {{$key == 0? "checked" :"" }} >
...
<div class="quantity">
 ...
 <input type="hidden" id="product_id" value="{{$product->id}}" name="product_id">
                                ...
                                <input type="text" id="quantity" name="qty" value="1" title="Qty" class="qty" size="4" pattern="[0-9]">
              ...
              <i class="icon-basket-loaded"></i> Add to cart
                            ...
                            <a class="add_wishlist" id="{{$product->id}}" onclick="addwish(this.id)"><i class="icon-heart"></i></a>
                    ...
                    <ul class="product-meta">
                        ...
                        <li>Tags: <a href="#" rel="tag">Happy Heels</a>, <a href="#" rel="tag">Women Shoes</a> </li>
                    </ul>
                    
                    <div class="product_share">
                        <span>Social-Media:</span>
                        <ul class="social_icons">
                            <li><a href="https://www.facebook.com/happyheels2020"><i class="ion-social-facebook"></i></a></li>
                           
                           
                            <li><a href="https://www.instagram.com/happyheels2020/"><i class="ion-social-instagram-outline"></i></a></li>
                        </ul>
                    </div>
                	...
                	<div class="tab-content shop_info_tab">
                      	...
                      	<div class="tab-pane fade" id="Additional-info" role="tabpanel" aria-labelledby="Additional-info-tab">
                        	<table class="table table-bordered">
                                ...
                                <tr>
                                    <td>Sizes</td>
                                    <td> @foreach($product_size as $size)
                                        {{$size}},
                                        @endforeach</td>
                                </tr>
                                <tr>
                                ...
                                <ul class="list_none comment_list mt-4">
                                    <li>
                                        <div class="comment_img">
                                            <img src="{{ asset('templateassets') }}/assets/images/user1.jpg" alt="user1"/>
                                        </div>
                                        <div class="comment_block">
                                            ...
                                            <p class="customer_meta">
                                                ...
                                                <span class="comment-date">January 5, 2023</span>
                                            </p>
                                            <div class="description">
                                                <p>This is realy good product</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="comment_img">
                                            <img src="{{ asset('templateassets') }}/assets/images/user2.jpg" alt="user2"/>
                                        </div>
                                        <div class="comment_block">
                                            <div class="rating_wrap">
                                                <div class="rating">
        ...
        <div class="row">
        	<div class="col-12">
            	<div class="heading_s1">
                	<h3>You may also like <i class="fa-solid fa-face-smile"></i> <i class="fa-solid fa-face-smile"></i> <i class="fa-solid fa-face-smile"></i> </h3>
                </div>
                                ...
                                <div class="product_action_box">
                                    <ul class="list_none pr_action_btn">
                                        <li class="add-to-cart">
                                             <a type="button" id="{{ $product->id }} " data-bs-toggle="modal"
                                        ...
                                        <li>
                                            <a id="{{$product->id}}" onclick="addwish(this.id)"><i class="icon-heart"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
