                    ...
                    <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1" data-loop="false"
                        ...
                        <div class="item">
                            <div class="product_wrap">
                                ...
                                <div class="product_info">
                                    <h6 class="product_title"><a href="{{url('/singleproduct/2')}}">Smart Watch
                                            External</a></h6>
                                    <div class="product_price">
                                        <span class="price">${{@$item->selling_price}}</span>
                                        <del>${{@$item->discount_price}}</del>
...
<div class="modal fade" id="cartmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModallevel"
    aria-hidden="true">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <div class="card">
                                <img src="" id="pimage" name="image" style="width:235px;height: 200px;">
                                <div class="card-body">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="qty" id="quantity" class="form-control" value="1"
                                pattern="[0-9]">
                        </div>
                        <br>
