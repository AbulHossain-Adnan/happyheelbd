    ...
    <div id="carouselExampleControls" class="carousel slide carousel-fade light_arrow" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item background_bg active"
                data-img-src="{{ asset('templateassets') }}/assets/images/women/banner1.jpg">
            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="cat_slider cat_style1 mt-4 mt-md-0 carousel_slider owl-carousel owl-theme nav_style5"
                        ...
                        data-responsive='{"0":{"items": "2"}, "480":{"items": "3"}, "576":{"items": "4"}, "768":{"items": "5"}, "991":{"items": "6"}, "1199":{"items": "10"}}'>
@foreach($brands as $item)

                        <div class="item">
                            <div class="categories_box">
                                <a href="#">
                                    <img src="{{ asset('images/'.@$item->brand_photo) }}"
                                        alt="cat_img1" />
                            ...
                            <div class="product_wrap">
                                ...
                                <div class="product_info">
                                    ...
                                    <div class="rating_wrap">
                                        ...
                                        <span class="rating_num">(155)</span>
                                    </div>
                                    <div class="pr_desc">
                            ...
                            <div class="product_wrap">
                                ...
                                <div class="product_info">
                                    ...
                                    <div class="rating_wrap">
                                        ...
                                        <span class="rating_num">(150)</span>
                                    </div>
                                    <div class="pr_desc">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit
                                            massa enim. Nullam id varius nunc id varius nunc.</p>
                ...
                <div class="col-12">
                    <div class="sale-banner mb-3 mb-md-4">
                        ...
                        <a class="hover_effect1" href="#">
                            <img src="{{ asset('product_images/'.@$banner->image_five) }}" alt="shop_banner_img11">
                        </a>
                    </div>
                </div>
            </div>
