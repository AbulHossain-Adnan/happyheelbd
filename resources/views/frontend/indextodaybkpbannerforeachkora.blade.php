    ...
    <div id="carouselExampleControls" class="carousel slide carousel-fade light_arrow" data-bs-ride="carousel">
        <div class="carousel-inner">
         @foreach($main_sliders as $item)
            <div class="carousel-item background_bg {{ $loop->first ? 'active' : '' }}" data-img-src="{{ asset('product_images/'.@$item->image_fore) }}">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <form>
                        <input type="email" required="" name="newsletter" id="newsemail" class="form-control rounded-0" placeholder="Enter Email Address">
                  ...
                  <!--   <div class="newsletter_form2">
                            ...
                            <input type="email" required="" class="form-control rounded-0"
                               ...
                               <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            <a type="button" onclick="addnewsletter()" class="btn btn-dark " name="submit"
                                value="Submit">Subscribe</a>
                       </form>
 -->
