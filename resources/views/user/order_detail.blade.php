      ...
      <div class="card-body">
        ...
        <div class="form-layout">
            <div class="row mg-b-20">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">PaymentType: <span class="tx-danger">*</span></label>
               ...
               <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Blnc Transection: <span class="tx-danger">*</span></label>
